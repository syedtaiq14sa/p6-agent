...
class SyncEngine {
  ...
  async readDatabase() {
    ...
    const projects = query(`SELECT PROJ_ID, PROJ_SHORT_NAME, PLAN_START_DATE, PLAN_END_DATE, SCD_END_DATE, LAST_RECALC_DATE, ORIG_PROJ_COST, ADD_DATE, CREATE_DATE, UPDATE_DATE FROM PROJECT ${projectFilter}`)
